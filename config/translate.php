...
return [
    'data' => [
        ...
        [
            'group' => 'form',
            'key' => 'farm.register_number_father',
            'text' => [
                'id' => 'Nomor Registrasi Induk Pejantan Ternak',
                'en' => 'Male Parent Registration Nuamber'
            ]
        ],
        [
            'group' => 'form',
            'key' => 'farm.register_number_mother',
            'text' => [
                'id' => 'Nomor Registrasi Induk Betina Ternak',
                'en' => 'Female Parent Registration Number'
            ]
        ],
        [
            'group' => 'form',
        ...
        [
            'group' => 'page',
            'key' => 'report.card.total',
            'text' => [
                'id' => 'Jumlah Ternak',
                'en' => 'Number of Livestock'
            ]
        ],
        [
            'group' => 'page',
            'key' => 'report.card.female',
            'text' => [
                'id' => 'Ternak Betina',
                'en' => 'Female Cattle'
            ]
        ...
        [
            'group' => 'page',
            'key' => 'report.chart.title',
            'text' => [
                'id' => 'Chart Kesehatan Ternak',
                'en' => 'Livestock Health Chart'
            ]
        ],
        [
            'group' => 'page',
            'key' => 'report.chart.sub_title',
            'text' => [
                'id' => 'chart berat, tinggi, panjang ternak',
                'en' => 'cattle weight, height, length chart'
            ]
        ],
        [
            'group' => 'page',
            'key' => 'report.chart.value',
            'text' => [
                'id' => 'Nilai Rata Rata',
                'en' => 'Average Value'
            ]
        ...
        [
            ...
            'key' => 'farm.list',
            'text' => [
                'id' => 'Daftar Data Ternak',
                'en' => 'List Livestock Data'
            ]
        ],
        [
            'group' => 'page',
        ...
        [
            ...
            'key' => 'medical.list',
            'text' => [
                'id' => 'Daftar Catatan Kesehatan',
                'en' => 'List Medical Record'
            ]
        ],
        [
            'group' => 'page',
            'key' => 'medical.create',
            'text' => [
                'id' => 'Buat Catatan Kesehatan',
                'en' => 'Create Medical Record'
            ]
        ],
        [
            'group' => 'page',
        ...
        [
            ...
            'key' => 'farm.register_number_father',
            'text' => [
                'id' => 'Nomer Registrasi Induk Pejantan',
                'en' => 'Register Number Father'
            ]
        ],
        [
            'group' => 'table',
            'key' => 'farm.register_number_mother',
            'text' => [
                'id' => 'Nomer Registrasi Induk Betina',
                'en' => 'Register Number Mother'
            ]
        ],
        [
            'group' => 'table',
        ...
        [
            ...
            'key' => 'empty.farm',
            'text' => [
                'id' => 'Belum ada daftar ternak yang tersedia',
                'en' => 'No livestock list available'
            ]
        ],
        [
            'group' => 'table',
